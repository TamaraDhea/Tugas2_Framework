		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<br>	
						<a href="<?php echo site_url('pegawai/create') ?>" type="button" class="btn btn-danger">Create Data Pegawai</a>	
						<br><br><br>
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda Yakin Hapus Data ?')">Delete </a>
